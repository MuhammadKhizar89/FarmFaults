...
export default function Leaderboard() {
  ...
  return loading?(
    ...
    <main className="min-h-[100vh] px-4 sm:px-0 sm:pl-5 lg:pl-16 xl:pl-20 bg-primary w-full pt-6  ">
      <div className=" sm:w-[73%] md:w-[75%] lg:w-[80%] xl:w-[58%] flex items-center justify-between   sm:ml-[5%] lg:ml-0">
